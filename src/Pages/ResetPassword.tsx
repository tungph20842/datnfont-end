...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      toast.error('Mã xác nhận không đúng.', { autoClose: 2000 });
  ...
  return (
    <section className="font-poppins">
      <div className="flex items-center justify-center h-full mt-3 mb-3 mx-auto max-w-7xl">
              ...
              <div className="max-w-md mx-auto">
                <div className="px-4 my-7">
                  ...
                  <form acceptCharset="UTF-8" className="p-0 m-0" id="forgot_password_form" onSubmit={handleResetPassword}>
                    ...
                    />
                     <label htmlFor="confirmationCode" className="text-lg font-medium text-gray-700 dark:text-gray-400">Mã Xác nhận</label>
        <input
          className="input-full w-full px-4 py-3 mt-3 bg-white-200 rounded-lg dark:text-white-400 dark:bg-white-800"
          type="text"
        ...
        />
         <label htmlFor="newPassword" className="text-lg font-medium text-gray-700 dark:text-gray-400">Mật khẩu mới</label>
        <input
          className="input-full w-full px-4 py-3 mt-3 bg-white-200 rounded-lg dark:text-white-400 dark:bg-white-800"
          type="password"
          name="newPassword"
